...
import com.angel.client.activity.ListaGenericaActivity.View;
...
public class EditGenericaActivity<V extends EditGenericaActivity.View<P>, P extends GenericProxy> extends AbstractActivity{
	...
	interface MyEventBinder extends EventBinder<EditGenericaActivity> { }
	...
	public interface View<P extends GenericProxy> extends  Editor{
	    ...
	    Widget asWidget();
	    void setPresenter(EditGenericaActivity presenter);
	  }
